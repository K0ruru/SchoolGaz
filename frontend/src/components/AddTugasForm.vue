  ...
  <div class="container">
    ...
    <div class="tugas-content">
      <div class="tugas-container">
        <div class="tugas-heading">
          <div class="tugas-info">
            <textarea name="" id="" cols="30" rows="2" placeholder="Tulis Soal..."></textarea>
            <!-- <h1>Fungsi CIN, COS, TAN</h1> -->
            <br>
            <br>
            <p>Deadline 12/02/24</p>
          </div>
