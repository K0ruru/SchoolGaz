  ...
  <div class="floating-overlay">
    <div class="floating-container fade-in fade-out">
      ...
      <div class="kelas-content">
        <router-link v-for="kelas in kelasData" style="text-decoration: none; color: inherit" :key="kelas.id_kelas"
          :to="{ name: 'kelas', params: { id: kelas.id_kelas } }" class="kelas-card">
