...
import AddKelasForm from "./AddKelasForm.vue";
const kelasForm =ref(false);
const showAddKelasForm = () => {
  kelasForm.value = true;
};
const closeAddKelasForm = () => {
  kelasForm.value = false;
};
...
<template>
    <AddKelasForm v-if="kelasForm" @closeAddKelasForm='closeAddKelasForm'/>
  <div class="container">
    <Navbar />
